...
- Grasp the argument through a central thesis, density tabs, concept cards, study path, optional understanding checks, and summaries before reading full prose.
...
4. Improve the generated HTML when needed:
   ...
   - Add optional understanding-check questions that point back to the source meaning, but keep them out of the main flow.
...
- Make the learning flow explicit: overview first, concepts second, source verification third, optional understanding check last.
